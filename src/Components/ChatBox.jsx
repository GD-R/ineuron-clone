...
const ChatBox = () => {
  ...
  return (
    <>
      <div className="fixed z-10 bottom-0 right-0 flex flex-col items-end ml-6 w-full">
    ...
    <div className="show-chat  mx-10 mb-6 mt-4 text-black hover:text-black  cursor-pointer ">
